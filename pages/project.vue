      ...
      <section id="how-does-it-work" class="mt-9">
        ...
        <b-row class="cmmx-0 mt-8">
          <b-col class="cmpx-30" lg="5" offset-lg="2" order-lg="2">
            ...
            <p class="mb-6 mb-lg-0">At this stage Tokens for Climate Care is set up as an <strong>art project</strong>. We see it as a chance to experiment with machine learning in the context of graphic design, our main field of work.<br>The goal of this project is to implement a <strong>fully working prototype</strong>, which we can publish and gather feedback on. It will enable us to judge commercial viability, for example as a <strong>logo generator</strong>. This will incur additional costs for commercially licensing big datasets and the extensive labeling required.</p>
          </b-col>
