  ...
  <main>
    <b-container fluid="md">
      <section>
        ...
        <b-row class="cmmx-0 mt-6">
          <b-col lg="5" offset-lg="1" class="cmpx-30 mb-6 mb-lg-0">
            ...
            <p class="mb-0"><strong>The installation is on view from 1 - 27 June 2021 at Somerset House London and from 19 October – 21 November 2021 at MAK, Vienna.</strong></p>
          </b-col>
      ...
      <section class="mt-9 mb-9">
        ...
        <b-row class="mt-9">
          <b-col lg="1" order-lg="2" class="mb-6 mb-lg-0">
            <img src="/mak_logo.png" width="100px">
          </b-col>
          <b-col lg="10" offset-lg="1" order-lg="1">
            <p class="f700 text-uppercase mb-0">Tokens for Climate Care</p>
            ...
            <p class="mb-4">Some Place Studio (Bika Rebek, Daniel Prost)</p>
...
export default {
  head: {
    title: 'TOKENS FOR CLIMATE CARE | Installation'
  }
}
</script>
